...
//   const deleteDocsByQuery = async (fileUrl) => {
//     console.log(fileUrl);
//     ///

//     setAdministration((prevAdministration) =>
//       prevAdministration.map((data) =>
//         data.fileUrl === fileUrl ? { ...data, deleting: true } : data
//       )
//     );
...
//     setAdministration((prevAdministration) =>
//       prevAdministration.map((data) =>
//         data.fileUrl === fileUrl ? { ...data, deleting: false } : data
//       )
//     );
...
//               <Text className="text-base"> Ines Status</Text>
//               <TouchableOpacity
//                 onPress={() => navigation.navigate("Add Ines Status")}
...
//                 No Ines Status images available, Add them
//               </Text>
//             ) : (
//               <View className="mt-8">
...
//                     <View
//                       key={data.id}
//                       className="mt-4 flex flex-col items-end bg-[#E5F0F7] border border-[#3287C2]  w-full p-4 rounded shadow-md"
//                     >
//                       <Image
//                         style={{
//                           width: 411,
...
//                         onPress={() => {
//                           deleteDocsByQuery(data.fileUrl);
//                         }}
//                       >
